...
int main(int argc,char** argv)
{
    ...
    nine_zero_method *nzm=new nine_zero_method();
    ...
    cout<<"------------------Generating Number Analysis using 9 and 0 and 1 \n";
    cout<<"[cause the others 2,3,4,5,6,7,8 cant be used to retrieve the 2+7+8+5 as example from 2785 number] \n";
    nzm->ni_ze(x);
    cout<<"------------------Number Analysis retrieved continue with other solutions or and methods \n";
    long long int tmp;
    int tms=0;
    cout<<"\n";
    tmp=x;
