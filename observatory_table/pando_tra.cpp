...
int pando_tra::orizontia_unreverse(int a,int b,int rasp){
    cout<<"using order of " << a << " " << b <<" and pattern value of " << rasp <<"\n";
     int x=7;
     clear_pos();
     stt=0;
     for(int i=0;i<=5;i++){
       ...
       if(stt==1){
                    ...
                    if(rvl[1]==rasp){fnd=1;}
                    cout<<"Possible sum \n";
                    cout<<"@7-6 : "<< rvl[0] << " and " << rvl[1] <<" FOUND " << fnd <<"\n";
                    break;
                 }
     }
     //if(stt==0){cout<<"-------\n";}
    // if(stt==1){
     ...
     for(int i=0;i<=5;i++){
       ...
       if(stt==1){
                    ...
                    if(rvl[0]==rasp){fnd=1;}
                    if(rvl[1]==rasp){fnd=1;}
                    cout<<"@6-5 : "<< rvl[0] << " and " << rvl[1] <<" FOUND " << fnd <<"\n";
                    break;
                 }
     }
    // if(stt==0){cout<<"-------\n";}
     ...
     for(int i=0;i<=5;i++){
       ...
       if(stt==1){
                    ...
                    if(rvl[0]==rasp){fnd=1;}
                    if(rvl[1]==rasp){fnd=1;}
                    cout<<"@5-4 : "<< rvl[0] << " and " << rvl[1] <<" FOUND " << fnd <<"\n";
                    break;
                 }
     }
     //if(stt==0){cout<<"-------\n";}
     ...
     for(int i=0;i<=5;i++){
       ...
       if(stt==1){
                    ...
                    if(rvl[0]==rasp){fnd=1;}
                    if(rvl[1]==rasp){fnd=1;}
                    cout<<"@4-3 : "<< rvl[0] << " and " << rvl[1] <<" FOUND " << fnd <<"\n";
                    break;
                 }
     }
    // if(stt==0){cout<<"-------\n";}
     ...
     for(int i=0;i<=5;i++){
       ...
       if(stt==1){
                    ...
                    if(rvl[0]==rasp){fnd=1;}
                    if(rvl[1]==rasp){fnd=1;}
                    cout<<"@3-2 : "<< rvl[0] << " and " << rvl[1] <<" FOUND " << fnd <<"\n";
                    break;
                 }
     }
    // if(stt==0){cout<<"-------\n";}
     ...
     for(int i=0;i<=5;i++){
       ...
       if(stt==1){
                    ...
                    if(rvl[0]==rasp){fnd=1;}
                    if(rvl[1]==rasp){fnd=1;}
                    cout<<"@2-1 : "<< rvl[0] << " and " << rvl[1] <<" FOUND " << fnd <<"\n";
                    break;
                 }
     }
    // if(stt==0){cout<<"-------\n";}
     ...
     for(int i=0;i<=5;i++){
       ...
       if(stt==1){
                    ...
                    if(rvl[0]==rasp){fnd=1;}
                    if(rvl[1]==rasp){fnd=1;}
                    cout<<"@1-8 : "<< rvl[0] << " and " << rvl[1] <<" FOUND " << fnd <<"\n";
                    break;
                 }
     }
     //if(stt==0){cout<<"-------\n";}
     ...
     for(int i=0;i<=5;i++){
       ...
       if(stt==1){
                    ...
                    if(rvl[0]==rasp){fnd=1;}
                    if(rvl[1]==rasp){fnd=1;}
                    cout<<"@8-7 : "<< rvl[0] << " and " << rvl[1] <<" FOUND " << fnd <<"\n";
                    break;
                 }
     }
    // }
...
int pando_tra::orizontia_reverse(int a,int b,int rasp){
  cout<<"using order " << b << " " << a <<" and pattern value of " << rasp <<"\n";
 int x=7;
     clear_pos();
     stt=0;
     for(int i=0;i<=5;i++){
...
int pando_tra::katheta_unreverse(int a ,int b,int rasp){
  cout<<"using in order " << a << " down and up  " << b <<" and pattern value of " << rasp <<"\n";
  clear_pos();
  rst=0;
  for(int i=0;i<=5;i++){
     if(okto[i]==a){posz[0]=i-1; rvl[0]=okto[posz[0]];
     for(int y=0;y<=5;y++){
     if(efta[y]==b && i==y){posz[1]=y-1;rvl[1]=efta[posz[1]]; stt=1;rst=1;}
     }
     }
  }
  if(stt==1){
...
int pando_tra::katheta_reverse(int a,int b,int rasp){
 cout<<"using in order " << b << " down and up  " << a <<" and pattern value of " << rasp <<"\n";
  clear_pos();
  rst=0;
  for(int i=0;i<=5;i++){
