...
int range_gen::gen_them(long long int xx,int start_custom,int end_custom){
    ...
    range_four[0]=remove_thr;range_four[1]=remove_thr+1;range_four[2]=remove_thr+2;range_four[3]=xx;
...
int range_gen::show_one(){for(int i=0;i<=1;i++){cout<< range_one[i] << " ";}  return 0;}

int range_gen::show_two(){for(int i=0;i<=1;i++){cout<<range_two[i] << " ";} return 0;}

int range_gen::show_three(){for(int i=0;i<=3;i++){cout<<range_three[i] << " ";} return 0;}

int range_gen::show_four(){for(int i=0;i<=3;i++){cout<<range_four[i]<<" ";} return 0;}

int range_gen::show_five(){for(int i=0;i<=6;i++){cout<<range_five[i] << " ";} return 0;}
